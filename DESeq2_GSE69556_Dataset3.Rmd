...
conv_cts56 <- merge(cts56_df, conversion, by = "gene_id")
...
pheatmap(conv_cts_fixed56[fixedtop20_56, ], cluster_rows = TRUE, cluster_cols = FALSE, show_rownames = TRUE, color = viridis(n= 10000, alpha = 1, begin = 0, end = 1, option = "viridis"), border_color = "NA", main = "Top 20 Positive Genes '56", angle_col = 45)
...
pheatmap(conv_cts56[top56,], cluster_rows=TRUE, show_rownames=TRUE,
         cluster_cols=FALSE, color = viridis(n= 10000, alpha = 1, begin = 0, end = 1, option = "viridis"), border_color = "NA", main = "20 Most Varied Genes '56", angle_col = 45) #, annotation_col=meta_39$Genotype)
```
#volcano plots
```{r}
...
gene_targets_unique_df_56<- as.data.frame(gene_targets_unique)
gene_targets_unique_df_56 <- setNames(gene_targets_unique_df_56, c("gene_name"))
...
target_gene_overlap_56 <- merge(deg_56_up, gene_targets_unique_df_56, by = "gene_name")
View(target_gene_overlap_56)
