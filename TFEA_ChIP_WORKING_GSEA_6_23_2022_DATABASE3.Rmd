...
Database3_plot <- plot_ES(pkd_tf_gsea_database3, LFC = alldegs3_table$log2FoldChange, specialTF = TF.highlight3, TF_colors = col)
...
Database3_plot<- Database3_plot %>% add_annotations(x=4600, y=0.32818, xref= "x", yref= "y", text = "EP300", xanchor='top', showarrow = T, arrowhead = 3, arrowsize = 0.3, font = list(size = 6))
