...
pheatmap(conv_cts[top,], cluster_rows=TRUE, show_rownames=TRUE,
         cluster_cols=FALSE, color = viridis(n= 10000, alpha = 1, begin = 0, end = 1, option = "viridis"), border_color = "NA", main = "20 Most Varied LFC Genes", angle_col = 45) #, annotation_col=meta_39$Genotype)
