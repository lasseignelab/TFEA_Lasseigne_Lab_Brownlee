...
fixedtop20_19 <- order(conv_cts_fixed19$Pkd2KO, decreasing = TRUE)[1:20]
...
fixedbottom20_19 <- order(conv_cts_fixed19$Pkd2KO, decreasing = FALSE)[1:20]
...
pheatmap(conv_cts19[top19,], cluster_rows=TRUE, show_rownames=TRUE, cluster_cols=TRUE, color = viridis(n= 10000, alpha = 1, begin = 0, end = 1, option = "viridis"), border_color = "NA", main = "20 Most Varied Genes Cystic P28", angle_col = 45) #, annotation_col=meta_39$Genotype)
```
